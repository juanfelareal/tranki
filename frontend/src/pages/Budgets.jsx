  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card border border-border/50 rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-border/50 flex items-center justify-between bg-black/[0.01]">
                    ...
                    {isEditing ? (
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setTempAmount(e.target.value)}
                          placeholder="0"
                          className="w-28 px-3 py-1.5 text-sm border border-border/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 tabular-nums"
                          autoFocus
                        />
                        <button
                        ...
                        <button
                          ...
                          className="p-1.5 text-muted hover:bg-black/5 rounded-lg transition-all"
                        >
                          <X size={16} />
                        </button>
                      </div>
                      ...
                      <>
                        ...
                        <button
                          ...
                          className="p-2 text-muted hover:text-primary hover:bg-black/5 rounded-xl transition-all duration-75"
                        >
                          <Edit2 size={16} />
                        </button>
                      </>
      ...
      {/* Tips */}
      <div className="glass-card border border-accent-yellow/30 rounded-2xl p-5 bg-accent-yellow/5">
