...
import {
  ...
  Cloud, AlertTriangle, Check, Info, Crown, ArrowRight
} from 'lucide-react';
...
const Settings = () => {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Danger Zone */}
      <div className="glass-card-premium border border-expense/30 rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-expense/20 bg-orange-50">
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl w-full max-w-sm overflow-hidden animate-fadeIn shadow-premium">
