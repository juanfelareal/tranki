  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <form onSubmit={handleSearch} className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-white/80 backdrop-blur-sm border border-border/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
            />
          </div>
          <button
            type="button"
        ...
        {/* Filter Panel */}
        {showFilters && (
          <div className="glass-card border border-border/50 rounded-2xl p-5 space-y-4 animate-fadeIn">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 bg-white border border-border/50 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                >
      ...
      {selectedIds.length > 0 && (
        <div className="flex items-center justify-between bg-primary/5 border border-primary/20 rounded-xl px-5 py-4 animate-fadeIn">
      ...
      {transactions.length > 0 ? (
        <div className="glass-card border border-border/50 rounded-2xl overflow-hidden">
          {/* Header */}
          <div className="hidden sm:grid sm:grid-cols-12 gap-4 px-5 py-3 bg-black/[0.02] border-b border-border/50 text-xs font-medium text-muted uppercase tracking-wide">
          ...
          <div className="divide-y divide-border/50">
            {transactions.map((tx, index) => (
              <div
                key={tx.id}
                className={`grid grid-cols-12 gap-4 px-5 py-4 items-center hover:bg-black/[0.02] transition-all animate-fadeIn cursor-pointer ${
